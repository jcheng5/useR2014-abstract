...
In contrast, the \pkg{shiny} package makes it easy for \proglang{R} users to create interactive reports, in the form of web applications. Shiny has built-in functions that:
